...
def create_app(test_config=None):
    ...
    root = os.path.abspath(os.path.join(os.getcwd(), '..', 'frontend/build'))
    app = Flask(__name__, static_folder=root, template_folder=root)
    setup_db(app)
    ...
    def after_request(res):
        ...
        return res
    '''
    @Done: Create an endpoint to handle GET
    ...
    def retrieve_questions():
        ...
        current_questions = pageinate(request, selection)
    ...
    def add_question():
        ...
        if not ('question' in body and 'answer' in
                body and 'difficulty' in body and 'category' in body):
            abort(422)
    ...
    def play_quiz():
        try:
            ...
            if category['type'] == 'click':
                ...
                new_question = (random_question.format()
